...
class P00_Cover: UIViewController {
	...
	override func viewDidLoad() {
		...
		button.dropView.dropDownOptions = ["Cover", "Perfil de peñoles", "Gestión de la sustentabilidad", "Grupos de interes", "Transparencia y cumplimiento", "Desempeño económico", "Desempeño ambiental"]
...
class dropDownBtn: UIButton, dropDownProtocol {
	...
	func dropDownPressed(string: String) {
		...
		self.setTitle("Menu: "+string, for: .normal)
	...
	override init(frame: CGRect) {
		...
		self.backgroundColor = UIColor(white:0,alpha:0.4) //UIColor.red
